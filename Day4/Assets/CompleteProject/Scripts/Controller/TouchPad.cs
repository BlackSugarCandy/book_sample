...
namespace CompleteProject
{
	public class TouchPad : MonoBehaviour {
		...
		void Start () {
			...
			_button = this.transform.parent.FindChild("TouchPad").GetComponent<RectTransform>();
			_buttonFrame = this.transform.parent.FindChild("Frame").GetComponent<RectTransform>();
